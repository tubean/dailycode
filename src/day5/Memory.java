...
public class Memory {
  ...
  private static String intToAddress(int value) {
  ...
  static String malloc(long size) {
  ...
  private static void free(String iAddress, String fAddress) {
  ...
  static HashMap<String, Object> refTable = new HashMap<>();
  static { refTable.put("0x00000000", null); }

  // dereference object
  static Object dereference(String address) {
